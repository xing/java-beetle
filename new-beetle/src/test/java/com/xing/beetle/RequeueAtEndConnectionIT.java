...
class RequeueAtEndConnectionIT {
    ...
    void test(long ttl, boolean requeue, int expectedMessageFactor, BigDecimal expectedValueDiff) throws Exception {
        ...
        while ((msg = channel.basicGet(QUEUE, false)) != null) {
            ...
            if (msg.getEnvelope().isRedeliver() || msg.getProps().getHeaders() != null && msg.getProps().getHeaders().containsKey("x-death")) {
