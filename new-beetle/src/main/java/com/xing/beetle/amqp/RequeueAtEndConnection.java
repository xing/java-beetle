...
public class RequeueAtEndConnection implements ConnectionDecorator.Single {
    ...
    private class RequeueAtEndChannel implements ChannelDecorator.Single {
        ...
        public AMQP.Queue.DeclareOk queueDeclare(String queue, boolean durable, boolean exclusive, boolean autoDelete, Map<String, Object> arguments) throws IOException {
            ...
            if (ttlInMillis >= 0) {
                ...
                AMQP.Queue.DeclareOk ok = delegate.queueDeclare(queue + DEAD_LETTER_SUFFIX, durable, exclusive, autoDelete, deadLetterArgs);
    ...
    public Channel createChannel(int channelNumber) throws IOException {
        Channel channel = channelNumber >= 0 ? delegate.createChannel(channelNumber) : delegate.createChannel();
