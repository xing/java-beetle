...
public interface ChannelDecorator extends Channel {
  ...
  interface Async extends ChannelDecorator, com.xing.beetle.util.Async<Channel> {
    ...
    default String basicConsume(
        ...
        Consumer callback)
        throws IOException {
      return executeJoined(
          c ->
              c.basicConsume(queue, autoAck, consumerTag, noLocal, exclusive, arguments, callback));
    }
  ...
  interface Multiple extends ChannelDecorator {
    ...
    @Override
    default CompletableFuture<Command> asyncCompletableRpc(Method method) throws IOException {
      return delegateMap(c -> c.asyncCompletableRpc(method))
          .reduce(
          ...
          delegateMap(
                  c ->
                      c.basicConsume(
                          ...
                          exclusive,
                          arguments,
                          new MappingConsumer(callback, c, deliveryTagMapping())))
              .allMatch(tag::equals);
      if (!all) {
  ...
  interface Single extends ChannelDecorator {
    ...
    default String basicConsume(
        ...
        throws IOException {
      return delegate()
          .basicConsume(queue, autoAck, consumerTag, noLocal, exclusive, arguments, callback);
    }
  ...
  @Override
  default DeclareOk exchangeDeclare(
      String exchange,
      String type,
      boolean durable,
      boolean autoDelete,
    ...
    return (Exchange.DeclareOk)
        rpc(new Exchange.Declare.Builder()
                .exchange(exchange)
                .type(type)
                .durable(durable)
  ...
  default DeleteOk exchangeDelete(String exchange, boolean ifUnused) throws IOException {
    return (Exchange.DeleteOk)
        rpc(new Exchange.Delete.Builder()
                .exchange(exchange)
                .ifUnused(ifUnused)
                .nowait(false)
                .build())
  ...
  @Override
  default UnbindOk exchangeUnbind(
      String destination, String source, String routingKey, Map<String, Object> arguments)
      throws IOException {
    return (Exchange.UnbindOk)
        rpc(new Exchange.Unbind.Builder()
                .destination(destination)
                .source(source)
                .routingKey(routingKey)
                .arguments(arguments)
