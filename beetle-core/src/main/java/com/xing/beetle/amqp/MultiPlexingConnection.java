...
public class MultiPlexingConnection implements DefaultConnection.Decorator {
    ...
    public static class MultiPlexingChannel implements DefaultChannel.Decorator {
        ...
        public MultiPlexingChannel(Connection connection, Deduplicator deduplicator, boolean rejectAndRequeue) throws IOException {
            this(connection, -1, deduplicator, rejectAndRequeue);
        }

        MultiPlexingChannel(Connection connection, int channelNumber, Deduplicator deduplicator, boolean rejectAndRequeue) throws IOException {
        ...
        public String basicConsume(
            ...
            Consumer callBackForAll = new Consumer() {
                @Override
                ...
                public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                    ...
                    BeetleMessageAdaptor beetleMessageAdaptor = new BeetleMessageAdaptor(consumerTags.get(consumerTag), autoAck, rejectAndRequeue);
                    Delivery message = new Delivery(envelope, properties, body);
                    if(beetleMessageAdaptor.keyOf(message) != null) {

                        MessageListener<Delivery> dedup_handle_delivery_called = new MessageListener<>() {
                            @Override
        ...
        public GetResponse basicGet(String queue, boolean autoAck) throws IOException {
            if (autoAck) {
                ...
                return tagMapping.responseWithPseudoDeliveryTag(publisher, publisher.basicGet(queue, false));
            }
        }
    ...
    public MultiPlexingConnection(Connection delegate, Deduplicator deduplicator, boolean rejectAndRequeue) {
